...
namespace TEngine
{
    public static partial class Utility
    {
        public class OptimizedAES
        {
            ...
            public OptimizedAES(byte[] key, byte[] iv)
            {
        ...
        {
            static readonly StringBuilder StringBuilderCache = new StringBuilder(1024);
            ...
            {
                return System.Guid.NewGuid().ToString(format.ToString());
            }
