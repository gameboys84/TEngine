...
namespace Fantasy
{
   public static class NetworkProtocolHelper
   {
		...
		[MethodImpl(MethodImplOptions.AggressiveInlining)]
		public static void C2G_TestNotifyMessage(this Session session, C2G_TestNotifyMessage C2G_TestNotifyMessage_message)
		{
			session.Send(C2G_TestNotifyMessage_message);
		}
		[MethodImpl(MethodImplOptions.AggressiveInlining)]
		public static void C2G_TestNotifyMessage(this Session session, string msg)
		{
			using var C2G_TestNotifyMessage_message = Fantasy.C2G_TestNotifyMessage.Create();
			C2G_TestNotifyMessage_message.Msg = msg;
			session.Send(C2G_TestNotifyMessage_message);
		}
		[MethodImpl(MethodImplOptions.AggressiveInlining)]
		public static void G2C_TestNotifyMessage(this Session session, G2C_TestNotifyMessage G2C_TestNotifyMessage_message)
		{
			session.Send(G2C_TestNotifyMessage_message);
		}
		[MethodImpl(MethodImplOptions.AggressiveInlining)]
		public static void G2C_TestNotifyMessage(this Session session, string msg)
		{
			using var G2C_TestNotifyMessage_message = Fantasy.G2C_TestNotifyMessage.Create();
			G2C_TestNotifyMessage_message.Msg = msg;
			session.Send(G2C_TestNotifyMessage_message);
		}
		[MethodImpl(MethodImplOptions.AggressiveInlining)]
